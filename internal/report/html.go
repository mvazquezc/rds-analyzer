    ...
    <div class="container">
        <header>
            ...
            <div class="meta">
                ...
                {{if .OCPVersion}}<span> | Target OCP Version: {{.OCPVersion}}</span>{{end}}
            </div>
        </header>
        ...
        <section class="section">
            ...
            <div class="summary-grid">
                <div class="stat-card">
                    ...
                    <div class="label">Total CRs Scanned</div>
                </div>
                <div class="stat-card">
                    <div class="value">{{.Summary.TotalMissing}}</div>
                    <div class="label">Missing CRs</div>
                </div>
                <div class="stat-card">
                    <div class="value">{{.Summary.DiffCRs}}</div>
                    <div class="label">CRs with Differences</div>
                </div>
                <div class="stat-card">
                    <div class="value">{{.Summary.UnmatchedCRs}}</div>
                    <div class="label">Unmatched CRs</div>
                </div>
            </div>
        </section>
        ...
        <footer style="text-align: center; padding: 20px; color: #6c757d; font-size: 0.85rem;">
            Generated by RDS Analyzer | Rule-based validation engine
        </footer>
    </div>
